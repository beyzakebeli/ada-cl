...
from utils import merge_evidence
...
def load_and_prepare_data():
    ...
    return df_train, df_val, df_test, tokenizer, test_loader

# === MOCHEG-way of preprocessing ===
def prepare_clip_data():
    ...
    test_dataset = MultimodalDataset(df_test, processor=processor)
    test_loader = DataLoader(test_dataset, batch_size=2, shuffle=False, num_workers=4)

    return df_train, df_val, df_test, processor, test_loader